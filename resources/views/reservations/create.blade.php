...
<div class="mb-4">
    ...
    <h3 class="fw-bold mt-2 mb-1">Create Room Reservation</h3>
    <p class="text-muted mb-0">Submit a new room booking request.</p>
</div>
        ...
        <div class="card card-custom p-4">
            <form method="POST" action="{{ route('reservations.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="reservation_code" id="reservation_code" value="{{ old('reservation_code', $nextCode) }}" class="form-control bg-light" readonly>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="reservation_date" id="reservation_date" value="{{ old('reservation_date', date('Y-m-d')) }}" class="form-control @error('reservation_date') is-invalid @enderror" required>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-6">
                        ...
                        <input type="time" name="start_time" id="start_time" value="{{ old('start_time', '09:00') }}" class="form-control @error('start_time') is-invalid @enderror" required>
                        @error('start_time')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-6">
                        ...
                        <input type="time" name="end_time" id="end_time" value="{{ old('end_time', '11:00') }}" class="form-control @error('end_time') is-invalid @enderror" required>
                        @error('end_time')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="purpose" id="purpose" rows="3" class="form-control @error('purpose') is-invalid @enderror" placeholder="Describe the purpose of your reservation..." required>{{ old('purpose') }}</textarea>
                    @error('purpose')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
